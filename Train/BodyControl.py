...
class BodyControl(Node):
    def __init__(self, env):
        ...
        self.joint_velocities=[1.5, 1.5, 0.6]
        self.get_logger().info("BodyControl subscriber initialized")
    ...
    def move_robot(self):
        ...
        self.get_logger().info(f'Moving robot to new joint positions: { self.joint_positions}')
        self.pending_action = False
